                    ...
                    children: [
                      SizedBox(
                        ...
                        child: const DropDownTextField(
                          ...
                          enableSearch: false,
                          textFieldDecoration:
                              InputDecoration(hintText: '+977'),
                          dropDownList: [
                            DropDownValueModel(name: '+977', value: '+977'),
                            DropDownValueModel(name: '+56', value: '+56'),
                            DropDownValueModel(name: '+64', value: '+64'),
                            DropDownValueModel(name: '+44', value: '+44'),
                          ],
                        ),
                      ),
                      const SizedBox(
                      ...
                      Container(
                        ...
                        decoration: const BoxDecoration(
                            border: Border(
                          bottom: BorderSide(width: 1.15, color: darkGrey),
                        )),
                        child: Obx(
                          () => Text(
                            ...
                            children: [
                              ...
                              Material(
                                ...
                                child: InkWell(
                                  borderRadius: BorderRadius.circular(30),
                                  onTap: () {
                                    print('button back arrow is tapped');
